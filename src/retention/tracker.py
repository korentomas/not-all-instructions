"""Online BKT compliance tracker (GRM + Laplace) - the live selective-reinforcement
component. Verbatim port of the v1 harness; not wired into the offline eval path
(the BKT live mini-test is a pending minor v2 deliverable)."""
